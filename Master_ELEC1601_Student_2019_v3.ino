...
#define PIN_ANALOG_X 2        // joysitck - X&Y
#define PIN_ANALOG_Y 3
#define PIN_BUTTON 4
...
void setup()
{
    ...
    pinMode(PIN_BUTTON, INPUT); // button setup
...
void loop()
{
    ...
    stateJoy = '4'; // not defined, means stop
    

    
    valJoyX = analogRead(PIN_ANALOG_X);
    valJoyY = analogRead(PIN_ANALOG_Y);

    if (valJoyX < 500 && valJoyY < 700 && valJoyY > 350) {
      stateJoy = '0'; // left
    } else if (valJoyX > 550 && valJoyY < 700 && valJoyY > 350) {
        stateJoy = '1'; // right
    } else if (valJoyY > 550 && valJoyX < 700 && valJoyX > 350) {
        stateJoy = '2'; // forward
    } else if (valJoyY < 500 && valJoyX < 700 && valJoyX > 350) {
        stateJoy = '3'; // go back
    } else if (valJoyX > 450 && valJoyX < 550 && valJoyY < 570 && valJoyY > 500) {
      stateJoy = '4'; // stop
    }

    blueToothSerial.print(stateButton);
